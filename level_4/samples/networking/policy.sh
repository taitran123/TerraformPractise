...
curl --max-time 1.5  http://$ProductsUIClusterIP:8080 # http://10.101.59.148:8080
curl --max-time 1.5  http://$ProductsBusinessClusterIP:8080 # http://10.101.59.148:8080
curl --max-time 1.5  http://$ProductsDBClusterIP:8080 # http://10.102.228.27:8080
